                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_size_my" class="form-control" value="kecil,sederhana,besar" data-role="tagsinput" > 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="product_color_my" class="form-control" value="small,medium,large" data-role="tagsinput" > 
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="short_desc_my" id="textarea" class="form-control"  placeholder="Textarea text" ></textarea>     
                                        </div>
                                    </div>
                                </div> 	
                            </div> 
